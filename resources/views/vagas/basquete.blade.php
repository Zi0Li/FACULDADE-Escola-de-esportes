        ...
        <table class="striped">
            ...
            @foreach ($basquetee as $basquete)
                <tr>
                    ...
                    <td>
                        <form action="{{route('vagas.deleteBasquete', $basquete->id)}}" method="POST">
                            @method('DELETE')
                            @csrf
                            <a class="btn-floating btn-small waves-effect waves-light blue" href="{{ route('vagas.editBasquete', $basquete->id)}}">
